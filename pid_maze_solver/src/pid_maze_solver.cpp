...
public:
    PIDMazeSolver(int scene_number) : Node("turn_controller"), scene_number_(scene_number) {
        ...
        if(scene_number_ == 1){
            angular_targets = {-0.08, -0.60, -0.702400, 0.0016, 0.709600, -0.0208, 0.702400, -0.021600, 0.682279, 1.410279, -0.782521, 1.415879, 1.089479, 1.38};
            ...
            pose_targets = {
                ...
                {4.902022,  1.498381, 0.0},
                {5.000065,  1.878134, 0.0}
